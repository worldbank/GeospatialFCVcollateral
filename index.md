...
On this site you can find additional resources to accompany the World Bank's [Enhancing FCV Operations with Geospatial ICT Tools](www.google.com) online course. These course materials and supplementary resources support the use of novel data, such as [Satellite Imagery](#remotesensing), [Drone Imagery](#drones), and [Mobile Phone data](#mobile) in global development projects and data products. Most of the resources are in English, however you can <a href="#french_course_materials">click here to jump to the French materials located at the bottom of the page.</a>  
